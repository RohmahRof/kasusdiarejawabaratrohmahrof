...
lyr_2023_2.set('fieldLabels', {'OBJECTID': 'header label - visible with data', 'WADMKK': 'no label', 'WADMPR': 'no label', 'LUAS': 'no label', 'GIS_JM_PST': 'no label', 'GIS_NM_INS': 'no label', });
